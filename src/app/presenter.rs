...
impl App {
    ...
    pub fn footer_hint(&self) -> String {
        if self.mode == AppMode::Sql {
            return "1 browse  2 sql  Ctrl+Space completions  Tab cycle panes  F5 or click Run  Enter newline/apply completion  Home/End move  PgUp/PgDn scroll  q or click Quit outside editor".to_string();
        }
